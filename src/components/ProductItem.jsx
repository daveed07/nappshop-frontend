...
const ProductItem = ({ product }) => {
  ...
  const [add, setAdd] = useState(cart.find(item => item.id === product.id) ? colors.white : colors.main);
    ...
    <div className="product-item">
      ...
      <div className="text-container">
        ...
        <div className="product-bottom">
          <SubTitle size="medium" color={colors.main}>${product.price}</SubTitle>
          <Button secondary icon add={add === colors.main ? colors.white : colors.main} onClick={() => handleAddToCart(product)}>
